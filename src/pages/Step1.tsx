  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        ...
        const step = trail.steps.find((s) => s.id === 'step-1');
  ...
  if (videoFail) {
    return (
      <div className="min-h-screen bg-neutral-50">
        <TopBar title="Etapa 1" showBack />
        <div className="max-w-[420px] mx-auto px-4 py-6 space-y-6">
          <div className="space-y-4">
            <h2 className="text-xl font-bold">Como aproveitar seus benefícios</h2>
            <p className="text-gray-600">
              Assista ao vídeo curto e aprenda dicas simples para usar melhor seu benefício.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <Button fullWidth onClick={() => navigate('/mission-1')}>
              Continuar
            </Button>
            <Button fullWidth variant="ghost" onClick={() => navigate('/mission-1')}>
              Pular
            </Button>
          </div>
        </div>
      ...
      <div className="max-w-[420px] mx-auto px-4 py-6 space-y-6">
        <div className="space-y-4">
          <h2 className="text-xl font-bold">
            {stepData?.title || 'Como aproveitar seus benefícios'}
          </h2>
          <p className="text-gray-600">
